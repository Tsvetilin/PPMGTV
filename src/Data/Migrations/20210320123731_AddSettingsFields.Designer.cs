...
namespace Data.Migrations
{
    ...
    [Migration("20210320123731_AddSettingsFields")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Models.ContactLetter", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Data.Models.Setting", b =>
                {
                    ...
                    b.Property<string>("HomePageNewsContent")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("HomePageNewsPreContent")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("HomePageNewsSectionTitle")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("IsDeleted")
                        .HasColumnType("bit");

                    b.Property<bool>("IsHomePageGalleryPostTextVisible")
                        .HasColumnType("bit");

                    b.Property<bool>("IsHomePageGalleryPreTextVisible")
                        .HasColumnType("bit");

                    b.Property<bool>("IsHomePageLastGalleryVisible")
                        .HasColumnType("bit");

                    b.Property<bool>("IsHomePageNewsVisible")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Data.Models.Video", b =>
                {
                    ...
                    b.Property<DateTime>("PremiredOn")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Data.Models.Image", b =>
                {
                    b.HasOne("Data.Models.Gallery", null)
                        .WithMany("Images")
            ...
            modelBuilder.Entity("Data.Models.Video", b =>
                {
                    b.HasOne("Data.Models.ApplicationUser", "AddedBy")
                        .WithMany()
